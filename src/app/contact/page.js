  ...
  return (
    <>
      {showConfirmationPage ? (
        <ConfirmationPage onClose={closePage} />
      ) : (
        <>
          {category ? (
            isLoggedIn && (
                ...
                <div className="bg-white shadow-md rounded-lg w-full max-w-2xl py-8 px-10">
                  <div>
                    <div className="flex justify-between mb-4">
                      ...
                      <button onClick={handleBack} className="text-blue-500 text-xl hover:underline">
                        &larr;Back
                      </button>
                    </div>
                    <form onSubmit={handleSubmit}>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        <div className="relative font-medium">
                          ...
                          <label
                            htmlFor="fullName"
                            className={`absolute hover:cursor-text left-4 transition-all duration-300 ${
                              fullName
                                ? "text-sm top-2 text-gray-500"
                                : "top-4 text-gray-700 peer-focus:text-sm peer-focus:top-2 peer-focus:text-gray-500"
                            }`}
                          >
                            Full Name
                          </label>
            ...
            <div
              className="flex flex-col items-center justify-center py-2 bg-gray-100 mt-1"
                  ...
                  <div className="md:w-1/2 flex flex-col justify-center p-0 bg-gray-100">
                    <div className="flex flex-col w-full justify-center items-center">
                      <video width="435px" height="435px" autoPlay loop className="rounded-lg shadow-md">
                        <source
                          src="https://cdnl.iconscout.com/lottie/premium/thumb/customer-support-4619490-3849167.mp4"
                          type="video/mp4"
                        />
